...
[GIN-debug] GET    /demo/index               --> func/controller.(*Demo).Index-fm (6 handlers)
[GIN-debug] GET    /demo/bind                --> func/controller.(*Demo).Bind-fm (6 handlers)
[GIN-debug] GET    /demo/dao                 --> func/controller.(*Demo).Dao-fm (6 handlers)
[GIN-debug] GET    /demo/redis               --> func/controller.(*Demo).Redis-fm (6 handlers)
...
[INFO][2019-06-16T11:39:26.802][log.go:58] _com_mysql_success||affected_row=1||traceid=c0a8fe445d05b9ee07b80f9f66cb39b0||spanid=9dad47aa1408d2ac||source=/Users/niuyufu/go/src/func/dao/demo.go:24||proc_time=0.000000000||sql=SELECT * FROM `area`  WHERE (id = '1')||level=sql||current_time=2019-06-16 11:39:26||cspanid=
